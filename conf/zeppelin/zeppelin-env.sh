...
export SPARK_SUBMIT_OPTIONS='--master spark://spark-master:7077 --jars /opt/jars/postgresql-42.2.5.jar --total-executor-cores 2  --executor-memory 4G --driver-memory 2G'                   # (optional) extra options to pass to spark submit. eg) "--driver-memory 512M --executor-memory 1G".
